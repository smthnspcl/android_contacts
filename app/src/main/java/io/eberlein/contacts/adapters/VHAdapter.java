...
public class VHAdapter<T extends RealmObject, V extends VH<T>> extends RealmRecyclerViewAdapter<T, V> {
    private Class<V> cls;

    public VHAdapter(Class<V> cls, OrderedRealmCollection<T> data){
        super(data, true);
        this.cls = cls;
    }
